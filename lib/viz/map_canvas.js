...
var MapCanvas = function(map, canvas, hlcanvas, params) {
  ...
  // following are variables used by mouse events on Hlightlight Canvas
  this.hlcanvas.selected = [];
  this.hlcanvas.brushRect = undefined;
  this.hlcanvas.isBrushing = false;
  this.hlcanvas.startX = -1;
  this.hlcanvas.startY = -1;
  this.hlcanvas.currentX = -1;
  this.hlcanvas.currentY = -1;
  this.hlcanvas.startPX = undefined;
  this.hlcanvas.startPY = undefined;
  this.hlcanvas.isMouseDown = false;
  this.hlcanvas.isMouseUp = false;
  this.hlcanvas.isMouseMove = false;
  this.hlcanvas.isKeyDown = false;
  this.hlcanvas.map = map;
  this.hlcanvas.highlightExt = this.highlightExt;
  this.hlcanvas.highlight = this.highlight;
  this.hlcanvas.clearCanvas = this.clearCanvas;
  this.hlcanvas.resetDraw = this.resetDraw;
  this.hlcanvas.triggerLink = this.triggerLink;
  this.hlcanvas.fadeCanvas = this.triggerLink;

  this.offsetX = 0;
  this.offsetY = 0;

  this.hlcanvas.addEventListener('touchmove', this.OnMouseMove, false);
  this.hlcanvas.addEventListener('touchstart', function(){this.OnMouseDown();}, false);
  ...
  this.hlcanvas.addEventListener('mousedown', function(){this.OnMouseDown();}, false);
...
MapCanvas.prototype = {
  ...
  OnMouseDown: function( evt ) {
    ...
    obj.startX = x;
    obj.startY = y;
    if (obj.brushRect && obj.brushRect.Contains(x, y) ) {
      obj.isBrushing = true;
    }

    if (obj.brushRect == undefined ||
        obj.brushRect && !obj.brushRect.Contains(x, y) ) {
