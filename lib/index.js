...
MapCola.MapCanvas= require("./viz/map_canvas.js").MapCanvas;
MapCola.HighlightCanvas = require("./viz/map_canvas.js").HighlightCanvas;
...
MapCola.prototype = {
  ...
  AddLayerFromURL : function(datasource, options) {
    ...
    xhr.onload = function(evt) {
      ...
      var mapCanvas = new MapCola.MapCanvas(shp_map, canvasEl, options);
